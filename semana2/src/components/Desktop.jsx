        ...
        <Row style={{border: "0px blue solid", marginTop: "2rem", marginBottom: "2rem"}} >
          <Col style={{border: "0px black solid"}} sm={12} md={12} lg={12} xl={12} xs={12} xxl={12}>
            <Row>
              ...
              <Col style={{border: "0px black red", textAlign: "end"} } xs={12} sm={12} md={6} lg={6} xl={6} xxl={6}>
                <Figure style={{marginLeft: "auto"}}>
                  <Figure.Image
                    ...
                    alt="Banner"
                    // @ts-ignore
                    src={require('../assets/banner-400x600.png')}
                  />
              ...
              <Col style={{border: "0px black blue", display: "flex", alignItems:"center", }} xs={12} sm={12} md={12} lg={6} xl={6} xxl={6}>
